...
public class LtpoFeaturesAction {
    private static final String PREF_KEY = "ltpo_features_enabled";
    ...
    public LtpoFeaturesAction(Context context, SharedPreferences prefs) {
